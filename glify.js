      ...
      var glify = {
        ...
        points: function points(settings) {
          var extendedSettings = {
            ...
            attachShaderVars: glify.attachShaderVarsPoints.bind(this),
        ...
        shapes: function shapes(settings) {
          var extendedSettings = {
            setupClick: glify.setupClick.bind(this),
            attachShaderVars: glify.attachShaderVarsShapes.bind(this),
            latitudeKey: glify.latitudeKey,
            longitudeKey: glify.longitudeKey,
            vertexShaderSource: function vertexShaderSource() {
              return glify.shader.vertex;
            ...
            fragmentShaderSource: function fragmentShaderSource() {
              return glify.shader.fragment.polygon1;
            },
            color: glify.color.random,
            closest: glify.closest.bind(this)
          };
        ...
        lines: function lines(settings) {
          var extendedSettings = {
            setupClick: glify.setupClick.bind(this),
            attachShaderVars: glify.attachShaderVarsLines.bind(this),
            latitudeKey: glify.latitudeKey,
            longitudeKey: glify.longitudeKey,
            vertexShaderSource: function vertexShaderSource() {
              return glify.shader.vertex;
            ...
            fragmentShaderSource: function fragmentShaderSource() {
              return glify.shader.fragment.polygon_w_opacity;
            },
            color: glify.color.random,
            closest: glify.closest.bind(this)
          };
        ...
        attachShaderVarsPoints: function attachShaderVars(size, gl, program, attributes) {
          var name,
              loc,
              attribute,bytes= 5;
        ...
        attachShaderVarsLines: function attachShaderVars(size, gl, program, attributes) {
          var name,
              loc,
              attribute,bytes = 5;
        ...
        attachShaderVarsShapes: function attachShaderVars(size, gl, program, attributes) {
          var name,
              loc,
              attribute,bytes = 6;
        ...
        shader: {
          ...
          fragment: {
            ...
            polygon_w_opacity: Buffer("cHJlY2lzaW9uIG1lZGl1bXAgZmxvYXQ7CnZhcnlpbmcgdmVjNCBfY29sb3I7Cgp2b2lkIG1haW4oKSB7CiAgZ2xfRnJhZ0NvbG9yID0gdmVjNChfY29sb3JbMF0sIF9jb2xvclsxXSwgX2NvbG9yWzJdLCBfY29sb3JbM10pOwp9", "base64")
          }
        }
      };
      ...
      resetVertices: function resetVertices() {
        ...
        for (; featureIndex < featureMax; featureIndex++) {
          ...
          for (i = 0, iMax = triangles.length; i < iMax; i) {
            ...
            verts.push(pixel.x, pixel.y, color.r, color.g, color.b, color.a);
            if (i==0)  console.log(pixel.x, pixel.y, color.r, color.g, color.b, color.a)
          }
        }
