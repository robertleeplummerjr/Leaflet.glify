...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Lines=void 0;var t=require("./base"),e=require("./color"),r=require("leaflet"),i=require("./line-feature-vertices"),s=require("./utils");const a={map:null,data:[],longitudeKey:null,latitudeKey:null,setupClick:null,setupHover:null,vertexShaderSource:null,fragmentShaderSource:null,click:null,hover:null,color:e.Color.random,className:"",opacity:.5,weight:2,sensitivity:.1,sensitivityHover:.03,shaderVariables:{color:{type:"FLOAT",start:2,size:4}}};class o extends t.Base{constructor(t){if(super(t),this.bytes=6,o.instances.push(this),this.settings=Object.assign(Object.assign({},o.defaults),t),!t.data)throw new Error('no "data" array setting defined');if(!t.map)throw new Error('no leaflet "map" object setting defined');this.active=!0,this.allVertices=[],this.setup().render()}render(){this.resetVertices();const{canvas:t,gl:e,layer:r,vertices:i,settings:s,mapMatrix:a}=this,o=this.getBuffer("vertex"),n=this.getAttributeLocation("vertex"),l=this.getUniformLocation("opacity");e.uniform1f(l,s.opacity),e.bindBuffer(e.ARRAY_BUFFER,o);let c=i.length;const h=[];for(let f=0;f<c;f++){const t=i[f].array,e=t.length/this.bytes;for(let r=0;r<e;r++){const i=r*this.bytes;0!==r&&r!==e-1&&h.push(t[i],t[i+1],t[i+2],t[i+3],t[i+4],t[i+5]),h.push(t[i],t[i+1],t[i+2],t[i+3],t[i+4],t[i+5])}}this.allVertices=h;const u=new Float32Array(h);return c=u.BYTES_PER_ELEMENT,e.bufferData(e.ARRAY_BUFFER,u,e.STATIC_DRAW),e.vertexAttribPointer(n,2,e.FLOAT,!1,c*this.bytes,0),e.enableVertexAttribArray(n),this.matrix=this.getUniformLocation("matrix"),this.aPointSize=this.getAttributeLocation("pointSize"),a.setSize(t.width,t.height),e.viewport(0,0,t.width,t.height),e.uniformMatrix4fv(this.matrix,!1,a.array),this.attachShaderVariables(c),r.redraw(),this}resetVertices(){this.allVertices=[],this.vertices=[];const t=this.vertices,e=this.settings,r=e.data.features,s=e.map,a=e.latitudeKey,o=e.longitudeKey,n=r.length;let l,c,h,{color:u,opacity:f}=e,d=0;if(!u)throw new Error("color is not properly defined");for("function"==typeof u&&(c=u);d<n;d++){l=r[d],h=c?c(d,l):u;const e=new i.LineFeatureVertices({project:s.project.bind(s),latitudeKey:a,longitudeKey:o,color:h,opacity:f});e.fillFromCoordinates(l.geometry.coordinates),t.push(e)}return this}drawOnCanvas(t){if(!this.gl)return this;const{gl:e,settings:r,canvas:i,mapMatrix:s,matrix:a,allVertices:o,vertices:n}=this,{weight:l}=r,{scale:c,offset:h,zoom:u}=t,f=Math.max(u-4,4);if(e.clear(e.COLOR_BUFFER_BIT),e.viewport(0,0,i.width,i.height),e.viewport(0,0,i.width,i.height),e.vertexAttrib1f(this.aPointSize,f),u>18)s.setSize(i.width,i.height).scaleMatrix(c).translateMatrix(-h.x,-h.y),e.uniformMatrix4fv(a,!1,s.array),e.drawArrays(e.LINES,0,o.length/this.bytes);else if("number"==typeof l)for(let d=-l;d<l;d+=.5)for(let t=-l;t<l;t+=.5)s.setSize(i.width,i.height).scaleMatrix(c).translateMatrix(-h.x+t/c,-h.y+d/c),e.uniformMatrix4fv(a,!1,s.array),e.drawArrays(e.LINES,0,o.length/this.bytes);else if("function"==typeof l){let t=0;const a=r.data.features;for(let r=0;r<n.length;r++){const o=n[r].vertexCount,u=l(r,a[r]);for(let r=-u;r<u;r+=.5)for(let a=-u;a<u;a+=.5)s.setSize(i.width,i.height).scaleMatrix(c).translateMatrix(-h.x+a/c,-h.y+r/c),e.uniformMatrix4fv(this.matrix,!1,s.array),e.drawArrays(e.LINES,t,o);t+=o}}return this}static tryClick(t,e){let r,i,a=!1,n=null;o.instances.forEach(function(o){i=o.settings,r=i.sensitivity,o.active&&i.map===e&&i.click&&i.data.features.map(e=>{for(let i=1;i<e.geometry.coordinates.length;i++){let l=(0,s.pDistance)(t.latlng.lng,t.latlng.lat,e.geometry.coordinates[i-1][0],e.geometry.coordinates[i-1][1],e.geometry.coordinates[i][0],e.geometry.coordinates[i][1]);l<r&&(r=l,a=e,n=o)}})}),n&&n.settings.click(t,a)}static tryHover(t,e){let i,a,n=!1,l=null;o.instances.forEach(function(o){if(i=o.settings,a=i.sensitivityHover,!o.active)return;if(i.map!==e)return;if(!i.hover)return;let c=(0,r.geoJSON)(i.data.features).getBounds();(0,s.inBounds)(t.latlng,c)&&i.data.features.map(e=>{for(let r=1;r<e.geometry.coordinates.length;r++){let i=(0,s.pDistance)(t.latlng.lng,t.latlng.lat,e.geometry.coordinates[r-1][0],e.geometry.coordinates[r-1][1],e.geometry.coordinates[r][0],e.geometry.coordinates[r][1]);i<a&&(a=i,n=e,l=o)}})}),l&&l.settings.hover(t,n)}}exports.Lines=o,o.defaults=a,o.instances=[];
