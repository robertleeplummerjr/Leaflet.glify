...
"use strict";var t=this&&this.__extends||function(){var t=function(e,o){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var o in e)e.hasOwnProperty(o)&&(t[o]=e[o])})(e,o)};return function(e,o){function n(){this.constructor=e}t(e,o),e.prototype=null===o?Object.create(o):(n.prototype=o.prototype,new n)}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.CanvasOverlay=void 0;var e=require("./leaflet-bindings"),o=function(o){function n(t){var e=o.call(this)||this;return e._userDrawFunc=t,e._frame=null,e._redrawCallbacks=[],e}return t(n,o),n.prototype.drawing=function(t){return this._userDrawFunc=t,this},n.prototype.params=function(t){return console.log("CanvasOverlay - params:  options"),console.log(t),e.Util.setOptions(this,t),this},n.prototype.redraw=function(t){return"function"==typeof t&&this._redrawCallbacks.push(t),null===this._frame&&(this._frame=e.Util.requestAnimFrame(this._redraw,this)),this},n.prototype.onAdd=function(t){console.log("canvasOverlay - onAdd"),this._map=t,this.canvas=this.canvas||document.createElement("canvas");var o=t.getSize(),n=t.options.zoomAnimation&&e.Browser.any3d;return this.canvas.width=o.x,this.canvas.height=o.y,this.canvas.className="leaflet-zoom-"+(n?"animated":"hide"),console.log("canvasOverlay - this._pane"),console.log(this._pane),console.log("this._pane"),console.log(this._pane),t._panes[this._pane.toLowerCase()].appendChild(this.canvas),t.on("moveend",this._reset,this),t.on("resize",this._resize,this),n&&t.on("zoomanim",e.Layer?this._animateZoom:this._animateZoomNoLayer,this),this._reset(),this},n.prototype.onRemove=function(t){return t.getPanes().myownpane.removeChild(this.canvas),t.off("moveend",this._reset,this),t.off("resize",this._resize,this),t.options.zoomAnimation&&e.Browser.any3d&&t.off("zoomanim",e.Layer?this._animateZoom:this._animateZoomNoLayer,this),this},n.prototype.addTo=function(t,e){return console.log("canvasOverlay - addTo"),console.log("this"),console.log(this),console.log("pane"),console.log(e),this._pane=e,t.addLayer(this),this},n.prototype._resize=function(t){this.canvas.width=t.newSize.x,this.canvas.height=t.newSize.y},n.prototype._reset=function(){var t=this._map.containerPointToLayerPoint([0,0]);e.DomUtil.setPosition(this.canvas,t),this._redraw()},n.prototype._redraw=function(){var t=this._map,o=this.canvas,n=t.getSize(),s=t.getBounds(),a=180*n.x/(20037508.34*(s.getEast()-s.getWest())),r=t.getZoom(),i=new e.LatLng(s.getNorth(),s.getWest()),c=this._unclampedProject(i,0);for(this._userDrawFunc&&this._userDrawFunc({bounds:s,canvas:o,offset:c,scale:Math.pow(2,r),size:n,zoomScale:a,zoom:r});this._redrawCallbacks.length>0;)this._redrawCallbacks.shift()(this);this._frame=null},n.prototype._animateZoom=function(t){var o=this._map,n=o.getZoomScale(t.zoom,o.getZoom()),s=this._unclampedLatLngBoundsToNewLayerBounds(o.getBounds(),t.zoom,t.center).min;e.DomUtil.setTransform(this.canvas,s,n)},n.prototype._animateZoomNoLayer=function(t){var o=this._map,n=o.getZoomScale(t.zoom,o.getZoom()),s=o._getCenterOffset(t.center)._multiplyBy(-n).subtract(o._getMapPanePos());e.DomUtil.setTransform(this.canvas,s,n)},n.prototype._unclampedProject=function(t,o){var n=this._map.options.crs,s=n.projection.R,a=Math.PI/180,r=t.lat,i=Math.sin(r*a),c=new e.Point(s*t.lng*a,s*Math.log((1+i)/(1-i))/2),h=n.scale(o);return n.transformation._transform(c,h)},n.prototype._unclampedLatLngBoundsToNewLayerBounds=function(t,o,n){var s=this._map._getNewPixelOrigin(n,o);return new e.Bounds([this._unclampedProject(t.getSouthWest(),o).subtract(s),this._unclampedProject(t.getNorthWest(),o).subtract(s),this._unclampedProject(t.getSouthEast(),o).subtract(s),this._unclampedProject(t.getNorthEast(),o).subtract(s)])},n}(e.Layer);exports.CanvasOverlay=o;
},{"./leaflet-bindings":"IxA4"}],"pR9a":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Base=void 0;var e=require("./map-matrix"),t=require("./canvas-overlay"),r=function(){function r(r){var a=this;console.log("base - constructor"),console.log(r),this.pixelsToWebGLMatrix=new Float32Array(16),this.mapMatrix=new e.MapMatrix,this.active=!0,this.vertexShader=null,this.fragmentShader=null,this.program=null,this.matrix=null,this.vertices=null;var s=Boolean(r.preserveDrawingBuffer);console.log("Base - new CanvasOverlay - BEFORE addTo");var i=this.layer=new t.CanvasOverlay(function(e){return console.log("Base - new CanvasOverlay - addTo"),a.drawOnCanvas(e)}).addTo(r.map,r.pane);console.log("Base - new CanvasOverlay - AFTER addTo");var o=this.canvas=i.canvas;o.width=o.clientWidth,o.height=o.clientHeight,o.style.position="absolute",r.className&&(o.className+=" "+r.className),this.gl=o.getContext("webgl2",{preserveDrawingBuffer:s})||o.getContext("webgl",{preserveDrawingBuffer:s})||o.getContext("experimental-webgl",{preserveDrawingBuffer:s})}return r.prototype.attachShaderVariables=function(e){if(!this.settings.shaderVariables)return this;var t=this.gl,r=this.program,a=this.settings.shaderVariables;for(var s in a)if(a.hasOwnProperty(s)){var i=a[s],o=t.getAttribLocation(r,s);if(o<0)throw new Error("shader variable "+s+" not found");t.vertexAttribPointer(o,i.size,t[i.type],!!i.normalize,e*(i.bytes||5),e*i.start),t.enableVertexAttribArray(o)}return this},r.prototype.setData=function(e){return this.settings.data=e,this},r.prototype.setup=function(){var e=this.settings;return e.click&&e.setupClick(e.map),e.hover&&e.setupHover(e.map,e.hoverWait),console.log("Base - setup"),console.log(e),this.setupVertexShader().setupFragmentShader().setupProgram()},r.prototype.setupVertexShader=function(){var e=this.gl,t=this.settings,r="function"==typeof t.vertexShaderSource?t.vertexShaderSource():t.vertexShaderSource,a=e.createShader(e.VERTEX_SHADER);return e.shaderSource(a,r),e.compileShader(a),this.vertexShader=a,this},r.prototype.setupFragmentShader=function(){var e=this.gl,t=this.settings,r="function"==typeof t.fragmentShaderSource?t.fragmentShaderSource():t.fragmentShaderSource,a=e.createShader(e.FRAGMENT_SHADER);return e.shaderSource(a,r),e.compileShader(a),this.fragmentShader=a,this},r.prototype.setupProgram=function(){var e=this.gl,t=e.createProgram();return e.attachShader(t,this.vertexShader),e.attachShader(t,this.fragmentShader),e.linkProgram(t),e.useProgram(t),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),e.enable(e.BLEND),this.program=t,this},r.prototype.addTo=function(e,t){return console.log("Base - addTo"),this.layer.addTo(e||this.settings.map,t||this.settings.pane),this.active=!0,this.render()},r.prototype.remove=function(){return this.settings.map.removeLayer(this.layer),this.active=!1,this},r}();exports.Base=r;
...
"use strict";var t=this&&this.__extends||function(){var t=function(e,r){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var r in e)e.hasOwnProperty(r)&&(t[r]=e[r])})(e,r)};return function(e,r){function i(){this.constructor=e}t(e,r),e.prototype=null===r?Object.create(r):(i.prototype=r.prototype,new i)}}(),e=this&&this.__assign||function(){return(e=Object.assign||function(t){for(var e,r=1,i=arguments.length;r<i;r++)for(var a in e=arguments[r])Object.prototype.hasOwnProperty.call(e,a)&&(t[a]=e[a]);return t}).apply(this,arguments)};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Lines=void 0;var r=require("./base"),i=require("./color"),a=require("./leaflet-bindings"),o=require("./line-feature-vertices"),n=require("./utils"),s={map:null,data:[],longitudeKey:null,latitudeKey:null,setupClick:null,setupHover:null,vertexShaderSource:null,fragmentShaderSource:null,click:null,hover:null,color:i.Color.random,className:"",opacity:.5,weight:2,sensitivity:.1,sensitivityHover:.03,pane:"overlayPane",shaderVariables:{color:{type:"FLOAT",start:2,size:3}}},l=function(r){function i(t){var a=this;if(console.log("Lines - constructor"),console.log(t),a=r.call(this,t)||this,i.instances.push(a),a.settings=e(e({},i.defaults),t),!t.data)throw new Error('no "data" array setting defined');if(!t.map)throw new Error('no leaflet "map" object setting defined');return a.active=!0,a.allVertices=[],a.setup().render(),a}return t(i,r),i.prototype.render=function(){console.log("Lines - render"),this.resetVertices();var t=this.pixelsToWebGLMatrix,e=this.settings,r=this,i=r.canvas,a=r.gl,o=r.layer,n=r.vertices,s=r.program,l=a.createBuffer(),c=a.getAttribLocation(s,"vertex"),u=a.getUniformLocation(s,"opacity");a.uniform1f(u,e.opacity),a.bindBuffer(a.ARRAY_BUFFER,l);for(var f=n.length,h=[],g=0;g<f;g++)for(var v=n[g].array,d=v.length/5,p=0;p<d;p++){var y=5*p;0!==p&&p!==d-1&&h.push(v[y],v[y+1],v[y+2],v[y+3],v[y+4]),h.push(v[y],v[y+1],v[y+2],v[y+3],v[y+4])}this.allVertices=h;var m=new Float32Array(h);return f=m.BYTES_PER_ELEMENT,a.bufferData(a.ARRAY_BUFFER,m,a.STATIC_DRAW),a.vertexAttribPointer(c,2,a.FLOAT,!1,5*f,0),a.enableVertexAttribArray(c),this.matrix=a.getUniformLocation(s,"matrix"),this.aPointSize=a.getAttribLocation(s,"pointSize"),t.set([2/i.width,0,0,0,0,-2/i.height,0,0,0,0,0,0,-1,1,0,1]),a.viewport(0,0,i.width,i.height),a.uniformMatrix4fv(this.matrix,!1,t),this.attachShaderVariables(f),o.redraw(),this},i.prototype.resetVertices=function(){console.log("Lines - resetVertices"),this.allVertices=[],this.vertices=[];var t,e,r,i=this.vertices,a=this.settings,n=a.data.features,s=a.map,l=a.latitudeKey,c=a.longitudeKey,u=n.length,f=a.color,h=0;if(!f)throw new Error("color is not properly defined");for("function"==typeof f&&(e=f);h<u;h++){t=n[h],r=e?e(h,t):f;var g=new o.LineFeatureVertices({project:s.project.bind(s),latitudeKey:l,longitudeKey:c,color:r});g.fillFromCoordinates(t.geometry.coordinates),i.push(g)}return this},i.prototype.drawOnCanvas=function(t){if(!this.gl)return this;console.log("Lines - drawOnCanvas");var e=this,r=e.gl,i=e.settings,a=e.canvas,o=e.mapMatrix,n=e.matrix,s=e.pixelsToWebGLMatrix,l=e.allVertices,c=e.vertices,u=i.weight,f=t.scale,h=t.offset,g=t.zoom,v=Math.max(g-4,4);if(r.clear(r.COLOR_BUFFER_BIT),r.viewport(0,0,a.width,a.height),s.set([2/a.width,0,0,0,0,-2/a.height,0,0,0,0,0,0,-1,1,0,1]),r.viewport(0,0,a.width,a.height),r.vertexAttrib1f(this.aPointSize,v),g>18)o.set(s).scaleMatrix(f).translateMatrix(-h.x,-h.y),r.uniformMatrix4fv(n,!1,o.array),r.drawArrays(r.LINES,0,l.length/5);else if("number"==typeof u)for(var d=-u;d<u;d+=.5)for(var p=-u;p<u;p+=.5)o.set(s).scaleMatrix(f).translateMatrix(-h.x+p/f,-h.y+d/f),r.uniformMatrix4fv(n,!1,o.array),r.drawArrays(r.LINES,0,l.length/5);else if("function"==typeof u)for(var y=0,m=i.data.features,x=0;x<c.length;x++){var w=c[x].vertexCount,b=u(x,m[x]);for(d=-b;d<b;d+=.5)for(p=-b;p<b;p+=.5)o.set(s).scaleMatrix(f).translateMatrix(-h.x+p/f,-h.y+d/f),r.uniformMatrix4fv(this.matrix,!1,o.array),r.drawArrays(r.LINES,y,w);y+=w}return this},i.tryClick=function(t,e){var r,a,o=!1,s=null;i.instances.forEach(function(i){a=i.settings,r=a.sensitivity,i.active&&a.map===e&&a.click&&a.data.features.map(function(e){for(var a=1;a<e.geometry.coordinates.length;a++){var l=n.pDistance(t.latlng.lng,t.latlng.lat,e.geometry.coordinates[a-1][0],e.geometry.coordinates[a-1][1],e.geometry.coordinates[a][0],e.geometry.coordinates[a][1]);l<r&&(r=l,o=e,s=i)}})}),s&&s.settings.click(t,o)},i.tryHover=function(t,e){var r,o,s=!1,l=null;i.instances.forEach(function(i){if(r=i.settings,o=r.sensitivityHover,i.active&&r.map===e&&r.hover){var c=a.geoJSON(r.data.features).getBounds();n.inBounds(t.latlng,c)&&r.data.features.map(function(e){for(var r=1;r<e.geometry.coordinates.length;r++){var a=n.pDistance(t.latlng.lng,t.latlng.lat,e.geometry.coordinates[r-1][0],e.geometry.coordinates[r-1][1],e.geometry.coordinates[r][0],e.geometry.coordinates[r][1]);a<o&&(o=a,s=e,l=i)}})}}),l&&l.settings.hover(t,s)},i.defaults=s,i.instances=[],i}(r.Base);exports.Lines=l;
