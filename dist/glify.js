...
"use strict";var t=this&&this.__extends||function(){var t=function(e,r){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var r in e)e.hasOwnProperty(r)&&(t[r]=e[r])})(e,r)};return function(e,r){function i(){this.constructor=e}t(e,r),e.prototype=null===r?Object.create(r):(i.prototype=r.prototype,new i)}}(),e=this&&this.__assign||function(){return(e=Object.assign||function(t){for(var e,r=1,i=arguments.length;r<i;r++)for(var a in e=arguments[r])Object.prototype.hasOwnProperty.call(e,a)&&(t[a]=e[a]);return t}).apply(this,arguments)},r=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Shapes=exports.defaults=void 0;var i=r(require("earcut")),a=r(require("geojson-flatten")),o=r(require("polygon-lookup")),n=require("./base"),s=require("./color"),l=require("./leaflet-bindings"),u=require("./utils");exports.defaults={map:null,data:[],longitudeKey:null,latitudeKey:null,setupClick:null,setupHover:null,vertexShaderSource:null,fragmentShaderSource:null,click:null,hover:null,color:s.Color.random,className:"",opacity:.5,shaderVariables:{color:{type:"FLOAT",start:2,size:3}},border:!1};var c=function(r){function n(t){var i=r.call(this,t)||this;if(n.instances.push(i),i.settings=e(e({},n.defaults),t),!t.data)throw new Error('no "data" array setting defined');if(!t.map)throw new Error('no leaflet "map" object setting defined');return i.polygonLookup=null,i.setup().render(),i}return t(n,r),n.prototype.render=function(){this.resetVertices();var t=this,e=t.pixelsToWebGLMatrix,r=t.settings,i=t.canvas,a=t.gl,o=t.layer,n=t.vertices,s=(t.vertsLines,t.program),l=a.createBuffer(),u=new Float32Array(n),c=u.BYTES_PER_ELEMENT,h=a.getAttribLocation(s,"vertex"),f=a.getUniformLocation(s,"opacity");return a.uniform1f(f,r.opacity),a.bindBuffer(a.ARRAY_BUFFER,l),a.bufferData(a.ARRAY_BUFFER,u,a.STATIC_DRAW),a.vertexAttribPointer(h,2,a.FLOAT,!1,5*c,0),a.enableVertexAttribArray(h),this.matrix=a.getUniformLocation(s,"matrix"),e.set([2/i.width,0,0,0,0,-2/i.height,0,0,0,0,0,0,-1,1,0,1]),a.viewport(0,0,i.width,i.height),a.uniformMatrix4fv(this.matrix,!1,e),this.attachShaderVariables(c),o.redraw(),this},n.prototype.resetVertices=function(){this.vertices=[],this.vertsLines=[],this.polygonLookup=new o.default;var t,e,r,n,s,c,h,f,p,d,g,v,y=this.vertices,b=this.vertsLines,A=this.polygonLookup,_=this.settings,E=_.data,x=_.color,R=0;switch(E.type){case"Feature":A.loadFeatureCollection({type:"FeatureCollection",features:[E]}),r=a.default(E);break;case"MultiPolygon":A.loadFeatureCollection({type:"FeatureCollection",features:[{type:"Feature",properties:{id:"bar"},geometry:{coordinates:E.coordinates}}]}),r=a.default(E);break;default:A.loadFeatureCollection(E),r=E.features}if(f=r.length,!x)throw new Error("color is not properly defined");for("function"==typeof x&&(s=x);R<f;R++){n=r[R],p=[],c=s?s(R,n):x,h=(n.geometry||n).coordinates,g=i.default.flatten(h),d=i.default(g.vertices,g.holes,g.dimensions),v=h[0][0].length;for(var F=0,L=d.length;F<L;F++){if(e=d[F],"number"!=typeof g.vertices[0])throw new Error("unhandled polygon");p.push(g.vertices[e*v+_.longitudeKey],g.vertices[e*v+_.latitudeKey])}for(F=0,L=p.length;F<L;F)t=_.map.project(new l.LatLng(p[F++],p[F++]),0),y.push(t.x,t.y,c.r,c.g,c.b);if(_.border){var m=[];for(F=1,L=g.vertices.length;F<L;F+=2)m.push(g.vertices[F],g.vertices[F-1]),m.push(g.vertices[F+2],g.vertices[F+1]);for(F=0,L=m.length;F<L;F)t=u.latLonToPixel(m[F++],m[F++]),b.push(t.x,t.y,c.r,c.g,c.b)}}return this},n.prototype.drawOnCanvas=function(t){if(!this.gl)return this;var e=t.scale,r=t.offset,i=t.canvas,a=this.mapMatrix,o=this.pixelsToWebGLMatrix;o.set([2/i.width,0,0,0,0,-2/i.height,0,0,0,0,0,0,-1,1,0,1]),a.set(o).scaleMatrix(e).translateMatrix(-r.x,-r.y);var n=this.gl;if(n.clear(n.COLOR_BUFFER_BIT),n.viewport(0,0,i.width,i.height),n.uniformMatrix4fv(this.matrix,!1,a.array),this.settings.border){var s=this.vertsLines,l=n.createBuffer(),u=(p=new Float32Array(s)).BYTES_PER_ELEMENT,c=this.program,h=n.getAttribLocation(c,"vertex"),f=n.getUniformLocation(c,"opacity");n.uniform1f(f,1),n.bindBuffer(n.ARRAY_BUFFER,null),n.bindBuffer(n.ARRAY_BUFFER,l),n.bufferData(n.ARRAY_BUFFER,p,n.STATIC_DRAW),null!==this.settings.shaderVariables&&this.attachShaderVariables(u),n.vertexAttribPointer(h,3,n.FLOAT,!1,5*u,0),n.enableVertexAttribArray(h),n.enable(n.DEPTH_TEST),n.viewport(0,0,i.width,i.height),n.drawArrays(n.LINES,0,this.vertsLines.length/5);var p,d=this.vertices;l=n.createBuffer(),u=(p=new Float32Array(d)).BYTES_PER_ELEMENT,c=this.program,h=n.getAttribLocation(c,"vertex"),f=n.getUniformLocation(c,"opacity");n.uniform1f(f,this.settings.opacity),n.bindBuffer(n.ARRAY_BUFFER,null),n.bindBuffer(n.ARRAY_BUFFER,l),n.bufferData(n.ARRAY_BUFFER,p,n.STATIC_DRAW),null!==this.settings.shaderVariables&&this.attachShaderVariables(u),n.vertexAttribPointer(h,2,n.FLOAT,!1,5*u,0),n.enableVertexAttribArray(h),n.enable(n.DEPTH_TEST),n.viewport(0,0,i.width,i.height)}return n.drawArrays(n.TRIANGLES,0,this.vertices.length/5),this},n.tryClick=function(t,e){var r,i,a;return n.instances.forEach(function(o){i=o.settings,o.active&&i.map===e&&i.click&&(a=o.polygonLookup.search(t.latlng.lng,t.latlng.lat))&&(r=i.click(t,a))}),void 0===r||r},n.tryHover=function(t,e){var r,i,a;return n.instances.forEach(function(o){i=o.settings,o.active&&i.map===e&&i.hover&&(a=o.polygonLookup.search(t.latlng.lng,t.latlng.lat))&&(r=i.hover(t,a))}),void 0===r||r},n.instances=[],n.defaults=exports.defaults,n}(n.Base);exports.Shapes=c;
